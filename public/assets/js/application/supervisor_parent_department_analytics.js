...
function SupervisorParentDepartmentAnalyticsModule(){
    ...
    function addOrRemoveDepartmentGraph($this) {
        ...
        if (departmentSeries) {
            ...
            $this.removeClass(thisInstance.colorsList[$(selectors.departmentTableRow).index($this) % thisInstance.colorsList.length].teamClass)
        }
        else {
            function successCallback() {
                ...
                thisInstance.departmentGraphInstance.departmentComparisonGraph.addSeries({
                    ...
                    color: thisInstance.colorsList[$(selectors.departmentTableRow).index($this) % thisInstance.colorsList.length].value
                });
                $this.addClass(thisInstance.colorsList[$(selectors.departmentTableRow).index($this) % thisInstance.colorsList.length].teamClass);
            }
